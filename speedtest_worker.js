...
var settings = {
	...
	telemetry_extra: "", //extra data that can be passed to the telemetry through the settings, is location name from front-end
    forceIE11Workaround: false, //when set to true, it will force the IE11 upload test on all browsers. Debug only
	log:"" // log entry, is provider name from front-end
};
